...
ctest --test-dir "$BUILD" -C Release --output-on-failure -R \
  "HF ringing (authentic|no narrowband)|ProperSRC HF metrics invariant|EngineCrossfade|processBlock survives 1000 authentic_color|Plugin reports SRC latency|14825 Hz imaging vs LegacyAccumulator"
