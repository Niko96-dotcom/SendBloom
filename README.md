...
- Wet-only overdrive blended independently via `distn`, processed at 4× host rate
  to reduce digital aliasing. Both wet branches share reconstruction filters.
  See [measurements, audio and preset impact](docs/fidelity-20260905/FOLLOWUP.md).
...
- Pressure send pad and MIDI CC1 momentary control; releasing pressure in Post
  mode cuts the wet tail even while dry playing continues, while Pre keeps trails.
...
- **Dry path:** Unity copy of the mono-summed input, taken **before** input gain. Never gated or distorted; delayed by the prepared SRC plus wet reconstruction latency so normal host PDC and internal wet/dry timing agree.
