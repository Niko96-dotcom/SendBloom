...
between host rate and the 32,768 Hz Schroeder tank core. See [ADR-003](architecture/ADR-003-proper-32k-src.md) and `cmake/R8brain.cmake` for integration details.
